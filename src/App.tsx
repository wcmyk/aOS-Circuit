...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-background px-6 py-8 text-foreground overflow-auto">
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm leading-6 text-slate-200">
                <p>
                  This MVP uses a local @aos/library-contracts workspace package for reusable aOS contracts. Circuit physics
                  stays self-contained while integrating cleanly with the aOS ecosystem.
                </p>
