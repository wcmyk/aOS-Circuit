...
export default function App() {
  ...
  const relationshipCopy =
    'This MVP uses a local @aos/library-contracts workspace package to stand in for reusable aOS contracts until the separate aos-library repository is available in the environment.'
